...
Material Dashboard React comes with 5 color filter choices for both the sidebar and the card headers (blue, green, orange, red and red) and an option to have a background image on the sidebar.
